...
set OBJDIR=build/Release_mingw64
set BUILDDIR=bin/Release_mingw64

if not exist build\Release_mingw64 (
mkdir build\Release_mingw64
)
if not exist bin\Release_mingw64 (
mkdir bin\Release_mingw64
)
set PATH=%MinGW%;%PATH%
