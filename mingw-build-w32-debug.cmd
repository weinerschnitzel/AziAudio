...
set OBJDIR=build/Debug_mingw32
set BUILDDIR=bin/Debug_mingw32

if not exist build\Debug_mingw32 (
mkdir build\Debug_mingw32
)
if not exist bin\Debug_mingw32 (
mkdir bin\Debug_mingw32
)
set PATH=%MinGW%;%PATH%
