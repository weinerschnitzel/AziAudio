...
set MinGW=C:\MinGW-w64\bin


set CFLAGS= -g -D_DEBUG -msse2 -DSSE2_SUPPORT -mstackrealign
set LDFLAGS= -static-libstdc++ -static-libgcc
set RESFLAGS= -D_DEBUG
set XA_FLAGS= -I"3rd Party/directx/include" -I"3rd Party"
set DS_FLAGS= -DXAUDIO_LIBRARIES_UNAVAILABLE
set SRCDIR=AziAudio

set OBJDIR=build/Debug_mingw64
set BUILDDIR=bin/Debug_mingw64

if not exist build\Debug_mingw64 (
mkdir build\Debug_mingw64
)
if not exist bin\Debug_mingw64 (
mkdir bin\Debug_mingw64
)
set PATH=%MinGW%;%PATH%
...
g++ -shared %CFLAGS% -o %obj%\AziAudioDS8_md.dll %DS_OBJS% %COMMON_OBJS% %LDFLAGS% -ldsound
g++ -shared %CFLAGS% -o %obj%\AziAudioXA2_md.dll %XA_OBJS% %COMMON_OBJS% %LDFLAGS% -lole32
PAUSE